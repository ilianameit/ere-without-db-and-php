...
<div class='acor-body'>
<ul>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Радиооборудование в автомобилях с двигателями экологического класса 4</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Радиооборудование в автомобилях с двигателями экологического класса 5</button></p></div></li>
...
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Коробка передач с автоматическим управлением модели ALLISON T270R</button></b></p></div></li>
...
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Установка каркаса и тента на платформе бортового автомобиля КАМАЗ</button></b></p></div></li>
</ul>
</div>
</div>
</li>
...
<label for='list11'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['eax']."" ?>' name='name'> ЭКСПЛУАТАЦИЯ АВТОМОБИЛЯ В ХОЛОДНЫЙ ПЕРИОД</button></b></p></label>
<div class='acor-body'>
<ul>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Перечень работ при ежедневном техническом обслуживании (ЕТО) для автомобилей с двигателями экологического класса 5</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Перечень работ при еженедельном техническом обслуживании (НТО) для автомобилей с двигателями экологического класса 5</button></p></div></li>
</ul>
</div>
</div>
</li>
...
<li>
<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Требования безопасности при ремонте двигателя СUMMINS с электронной системой управления</button></b></p></div></li>
...
<div class='acor-body'>
<ul>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Опрокидывание и опускание кабины вручную</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Опрокидывание и опускание кабины с помощью гидравлического подъемника кабины</button></p></div></li>
</ul>
</div>
</div>
</li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril2']."" ?>' name='name'>Приложение Б Химмотологическая карта</button></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril10']."" ?>' name='name'>Приложение (копия) Руководство по эксплуатации ZF- ASTRONIC mid Грузовые автомобили Стандарт ZF</button> </p></div></li>
</ul>
</div>