...
<ul class='countlist'>
  <li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vv']."" ?>' name='name'> ВАШЕМУ ВНИМАНИЮ</button></b></p></div></li>
	<li>
		...
		<div class='acor-body'>
		<ul>
		<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ep']."" ?>' name='name'>Технические характеристики шасси</button></b></p></div></li>
		...
		<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ep']."" ?>' name='name'>Эксплуатационная документация, запасные части, инструмент и принадлежности, которыми должно быть укомплектовано шасси</button></b></p></div></li>
	...
	<li>
		...
		<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ks']."" ?>' name='name'>Рама, тягово-сцепное устройство</button></b></p></div></li>
	...
	<li>
		...
		<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Центральная часть панели приборов</button></p></div></li>
		...
		<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Прожектор освещения борта надстройки</button></p></div></li>
		</ul>
		</div>
		</div>
		</li>
		...
		<li>
		<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Требования безопасности при эксплуатации автомобиля</button></b></p></div></li>
		...
		<li>
		<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Причины некорректного отключения аккумуляторных батарей</button></b></p></div></li>
		...
		<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Электронная система управление пневмоподвеской</button></b></p></div></li>
	...
	<li>
		...
		<label for='list15'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['eax']."" ?>' name='name'> ЭКСПЛУАТАЦИЯ АВТОМОБИЛЯ В ХОЛОДНЫЙ ПЕРИОД ВРЕМЕНИ</button></b></p></label>
		<div class='acor-body'>
		<ul>
	...
	<li>
		...
		<label for='list18'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'> ВОЗМОЖНЫЕ НЕИСПРАВНОСТИ АГРЕГАТОВ И СИСТЕМ АВТОМОБИЛЯ САМОПОМОЩЬ</button></b></p></label>
		<div class='acor-body'>
		<ul>
		...
		<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Требования безопасности при ремонте двигателяCummins  с электронной системой управления</button></b></p></div></li>
		...
		<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Блоки предохранителей и реле</button></p></div></li>
...
<div class='acor-body'>
<ul class='countlist'>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril1']."" ?>' name='name'>Приложение Б Химмотологическая карта автомобилей КАМАЗ-5325, 53257</button></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril3']."" ?>' name='name'>Приложение (копия) Подогреватель предпусковой дизельный Mini-24-GP-KAM</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril4']."" ?>' name='name'>Приложение (копия) Руководство по эксплуатации AIRTRONIC D2</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril5']."" ?>' name='name'>Приложение (копия) Руководство по эксплуатации Webasto AT 2000 STC</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril6']."" ?>' name='name'>Приложение (копия) Руководство по эксплуатации ZF- ECOLITE Синхронизированная коробка передач ZF 6S1000 TO, 6S1005 TO, 6S 800 TD, 6S 805 TD</button></p></div></li>
