...
<div class='acor-body'>
<ul>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>ДвигательКАМАЗ</button></p></div></li>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Двигатель CUMMINS</button></p></div></li>
</ul>
</div>
</div>
...
<li>
<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Управление муфтой привода вентилятора двигателя</button></b></p></div></li>
...
<input type='checkbox' name='chacor' id='list121'/>
<label for='list121'>
...
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня масла в картере коробки передач ПАО «КАМАЗ»</button></b></p></div></li>
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня масла в картерах главных передач ведущих мостов ПАО «КАМАЗ»</button></b></p></div></li>
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня масла в картере раздаточной коробки ПАО «КАМАЗ»</button></b></p></div></li>
<li>
<div class='btn'  name='name'>
...
<li>
<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Требования безопасности при ремонте двигателя Сummins c электронной системой управления</button></b></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Установка запасного колеса в горизонтальном положении на опоре</button></p></div></li>
</ul>
</div>
</div>
</li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril2']."" ?>' name='name'>Приложение Б Химмотологическая карта автомобилей КАМАЗ -43265, 65111</button></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril7']."" ?>' name='name'>Приложение (копия) Руководство по эксплуатации ZF-ECOMID Синхронизированная коробка передач ZF 9S 1110, 9S 1310</button></p></div></li>
</ul>
</div>