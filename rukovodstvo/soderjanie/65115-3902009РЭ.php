...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Панель приборов с электронной комбинацией приборов</button></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Включение/ отключение КОМ при установке коробки передач модели Fast Gear 9JS135 TA</button></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Эксплуатация автомобиля-самосвала при установке коробки передач модели Fast Gear 9JS135 TA</button></p></div></li>
...
<label for='list20'>
<p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня охлаждающей жидкости</button></b></p>
</label>
<div class='acor-body'>
<ul>
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня охлаждающей жидкости для автомобиля КАМАЗ-6540 с правым рулевым управлением (вариант)</button></p></div></li>
</ul>
</div>
</div>
</li>
<li>
<div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня масла в гидросистеме механизма подъема платформы</button></b></p></div></li>
<li>
<div class='btn'  name='name'>
...
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Предохранители и реле для автомобиля с двигателем экологического класса 3 с правым рулевым управлением и металлической панелью приборов</button></b></p></div></li>
<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Предохранители и реле для автомобиля с двигателем экологического класса 2, 3 с левым рулевым управлением и пластиковой панелью приборов</button></b></p></div></li>
...
<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril2']."" ?>' name='name'>Приложение 2 Химмотологическая карта автомобилей КАМАЗ моделей 43253, 43255, 53229, 55111, 65115, 65116, 65117, 6540</button></p></div></li>
