...
?> 
	...
	<div class='acor-body'>
		<ul class='countlist'>
			...
			<li>
				<div class='btn'  name='name'>
					...
					<ul>
						...
						<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ep']."" ?>' name='name'>Двигатель CUMMINS</button></p></div></li>
						</ul>
						</div>
						</div>
						</li>
				...
				<div class='btn'  name='name'>
					...
					<div class='acor-body'>
						<ul>
							...
							<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Регулирование угла наклона фар</button></b></p></div></li>
							<li>
								<div class='btn'  name='name'>
							...
							<div class='btn'  name='name'>
								...
								<label for='list17'>
								<p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Эксплуатация</button></b></p>
								</label>
								<div class='acor-body'>
								<ul>
								<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Особенности эксплуатации</button></p></div></li>
								...
								<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['ea']."" ?>' name='name'>Эксплуатация автомобиля-тягача в составе автопоезда</button></p></div></li>
								</ul>
								</div>
							</div>
							</li>							
			...
			<li>
				...
				<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['eax']."" ?>' name='name'>Подогрев восстановителя оксидов азота</button></b></p>
				</div></li>
				</ul>
				</div>
				</div>
			...
			<li>
				...
				<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Проверка уровня масла в картерах главных и колесных передач</button></b></p></div></li>
				...
				<div class='acor-body'>
				<ul>
				<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Фильтр грубой очистки топлива Ф. «UFI»</button></p></div></li>
				<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Фильтр грубой очистки топлива Ф. «FLEETGUARD»</button> </p></div></li>
				</ul>
				</div>
				</div>
				</li>
				...
				<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['tho']."" ?>' name='name'>Удаление влаги из фильтра-маслоотделителя (для двигателя КАМАЗ)</button></b></p></div></li>
			...
			<li>
				...
				<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Требование безопасности при ремонте двигателяCummins с электронной системой управления</button></b></p></div></li>
				<li>
					<div class='btn'  name='name'>
				...
				<li><div class='btn'  name='name'><p><b><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Воздушный фильтр топливного бака</button></b></p></div></li>
				...
				<li>
					...
					<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Предохранители и реле на автомобилях КАМАЗ моделей 6520, 6522 с двигателем КАМАЗ</button></p></div></li>
					<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['vn']."" ?>' name='name'>Предохранители и реле на автомобилях КАМАЗ моделей 6520, 65201 с двигателем Cummins</button> </p></div></li>
	...
	<div class='acor-body'>
		...
		<li><div class='btn'  name='name'><p><button value='<?php echo "".$rw1['idere'].'/'.$rw1['pril3']."" ?>' name='name'>Приложение Подогреватель предпусковой дизельный 14ТС-10-GP</button></p></div></li>
